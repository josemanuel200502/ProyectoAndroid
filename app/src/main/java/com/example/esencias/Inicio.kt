...
class Inicio : Fragment() {
    ...
    override fun onCreateView(
        ...
        // Nuevo: Configuración del botón de la wishlist
        val btnWishlistInicio: Button = view.findViewById(R.id.btnWishlistInicio)
        btnWishlistInicio.setOnClickListener {
            cargarFragment(WishListFragment())
        }
